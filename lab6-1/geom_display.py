...
def displayAll(flg = 0):
    if flg == 1:
        showResult("map1", 30.27236, 120.141376, 12)
        showResult("map2", 30.27236, 120.141376, 12)
        showResult("map3", 30.2843168, 120.076331797721, 13)
        showResult("map4", 30.2843168, 120.076331797721, 13)
        showResult("map5", 30.2843168, 120.076331797721, 13)
        showResult("map6", 30.2843168, 120.076331797721, 13)
        showResult("map7", 30.2843168, 120.076331797721, 13)
        showResult("map8", 30.282625865, 120.104952675, 16)
